    ...
    return (
        <div className="bg-white dark:bg-[#212121] h-full lg:h-[95%] block lg:flex  lg:m-4 rounded-md shadow-xl">
            ...
            <aside className="bg-amber-300  text-black h-[10%] lg:h-[100%] shadow-sm w-[100%] lg:w-[30vh] mr-4 pt-1 lg:pt-6">
                ...
                <div className='h-[100%]'>
                    <button onClick={() => setMenuOpen(!menuOpen)} className={` text-black gap-x-4 focus:outline-none flex lg:hidden justify-between p-2 items-center h-[100%] w-[100%]`}>
                        <p className="text-2xl font-bold">Menu de navegacion</p>
                        <FaBars className="text-3xl" />
                    </button>
                </div>
                {menuOpen && (
                    <div className='absolute w-[100%] h-[100%] top-24 left-0 bg-amber-300 text-black text-2xl font-bold flex flex-col items-center pt-20 z-50 lg:hidden'>
                        <div>
