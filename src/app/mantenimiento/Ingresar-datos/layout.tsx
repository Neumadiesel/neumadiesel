...
export default function LayoutIngresarDatos({
    ...
    const links = [
        ...
        },
        {
            ...
            href: '/mantenimiento/Ingresar-datos/medicion-por-equipo',
        },
        {
    ...
    return (
        <div className="bg-white dark:bg-[#212121] h-full md:h-[95%] block md:flex  md:m-4 rounded-md shadow-xl">
            {/* Navegacion latearl */}
            <aside className="bg-amber-300  text-black h-[10%] md:h-[100%] shadow-sm w-[100%] md:w-[30vh] mr-4 pt-1 md:pt-6">
                ...
                <div className='h-[100%]'>
                    <button onClick={() => setMenuOpen(!menuOpen)} className={` text-black gap-x-4 focus:outline-none flex md:hidden justify-between p-2 items-center h-[100%] w-[100%]`}>
                ...
                {menuOpen && (
                    <div className='absolute w-[100%] h-[100%] top-24 left-0 bg-amber-300 text-black text-2xl font-bold flex flex-col items-center pt-20 z-50 md:hidden'>
                        <div>
                            ...
                            <button onClick={() => setMenuOpen(false)} className="absolute pt-8 right-0 top-0 p-2">
                                <FaBars className="text-3xl" />
                            </button>
                        </div>
                        <ul>
