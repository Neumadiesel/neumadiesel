...
export default function Page() {
    return (
        <div className="bg-gray-100">
            ...
            <section className="flex flex-col items-center bg-white justify-center w-full h-full lg:h-[120vh] py-10 z-20 mx-auto gap-y-2 xl:gap-y-2 px-4 lg:px-0">
                <h3 className="text-3xl xl:text-4xl font-bold">Gestión Integral de Neumáticos</h3>
            ...
            <section className="flex flex-col items-center justify-center w-full h-full lg:h-[100vh] gap-y-10 py-10 z-20 mx-auto px-4 lg:px-0">
                ...
                <div className=" grid grid-cols-1 lg:grid-cols-3 gap-4 w-4/5 gap-x-4">
                    ...
                    <div className="flex flex-col gap-2 bg-white w-72  h-44 p-4 rounded-sm border border-gray-300">
            ...
            <section className="flex flex-col items-center justify-center bg-white w-full h-full lg:h-[100vh]  gap-y-10 py-8 z-20 mx-auto px-4 lg:px-0">
                ...
                <div className="flex flex-col lg:flex-row gap-4 w-full lg:w-3/4">
                    <div className="flex flex-col gap-2 bg-white w-full lg:w-80 h-80 p-4 rounded-sm border border-gray-200 shadow-sm">
