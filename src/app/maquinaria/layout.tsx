...
export default function RootLayout({
    ...
    return (
        <div className="bg-[#f1f1f2] dark:bg-[#212121] flex gap-x-5 min-h-screen">
            <main className="w-[35%] h-screen flex justify-center items-center">
                <div className="bg-white dark:bg-black shadow-xl rounded-lg w-[95%] h-[95%] ">
                    ...
                    <div className="grid grid-cols-3 h-[90%] overflow-scroll gap-x-4 gap-y-2 px-6">
                        {Camiones.map((camion) => (
