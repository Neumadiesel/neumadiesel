...
export default function Page() {
    return (
        <div className="flex flex-col overflow-x-hidden  h-full bg-[#f1f1f1] dark:bg-[#212121] pt-4 p-2 dark:text-white text-center w-full mx-auto   lg:p-3">
            <main className="w-[100%] lg:rounded-md mx-auto lg:p-4 h-[95%] ">
                <div className=" grid grid-cols-1 lg:flex w-full justify-between gap-2">
                    ...
                    <div className="flex text-center rounded-full">
                        <button className="bg-white dark:bg-neutral-900 font-semibold dark:hover:bg-neutral-600 hover:bg-neutral-200 px-4 w-20 py-2 rounded-l-full">
                            Semana
                        </button>
                        <button className="bg-white dark:bg-neutral-900 font-semibold dark:hover:bg-neutral-600 hover:bg-neutral-200 px-4 w-20 py-2 ">
                            Mes
                        </button>
                        <button className="bg-white dark:bg-neutral-900 font-semibold dark:hover:bg-neutral-600 hover:bg-neutral-200 px-4 w-20 py-2 rounded-r-full">
                            Año
                        </button>
                    </div>
                    ...
                    <div className="flex flex-row ">
                        <input
                            type="date"
                            className="bg-white dark:bg-neutral-900 dark:outline-none dark:hover:bg-neutral-800    hover:bg-neutral-200 px-4 py-2 rounded-l-full"
                        />
                        <input
                            type="date"
                            className="bg-white dark:bg-neutral-900 dark:outline-none dark:hover:bg-neutral-800    hover:bg-neutral-200  px-4 py-2 rounded-r-full"
                        />
                    </div>
                </div>
                {/* Principales KPI's */}
                <section className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-row justify-between mt-2 gap-2 col-span-2  row-span-1 row-start-3">
                    {/* Neumaticos Operativos */}
                    <div className="flex flex-row gap-2 items-center w-full lg:w-1/3 py-4 bg-white dark:bg-neutral-900 border-r-4 border-r-blue-500 shadow-md p-2 rounded-sm">
                    ...
                    {/* Equipos Operativos */}
                    <div className="flex flex-row gap-2 items-center w-full lg:w-1/3 py-4 bg-white dark:bg-neutral-900 border-r-4 border-r-amber-300 shadow-md p-2 rounded-sm">
                    ...
                    {/* Cantidad de alertas */}
                    <div className="flex flex-row gap-2 items-center w-full lg:w-1/3 py-4 bg-white dark:bg-neutral-900 border-r-4 border-r-red-500 shadow-md p-2 rounded-sm">
