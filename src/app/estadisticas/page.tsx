            ...
            <main className='w-[100%] lg:rounded-md mx-auto lg:p-4 h-[95%] '>
                <div className="flex w-full justify-between gap-2">
                    ...
                    <div className="flex text-center rounded-full">
                        <button className="bg-white dark:bg-gray-700 dark:hover:bg-gray-600         hover:bg-gray-200 px-4 w-20 py-2 rounded-l-full">Semana</button>
                        <button className="bg-white dark:bg-gray-700 dark:hover:bg-gray-600        hover:bg-gray-200 px-4 w-20 py-2 ">Mes</button>
                        <button className="bg-white dark:bg-gray-700 dark:hover:bg-gray-600    hover:bg-gray-200 px-4 w-20 py-2 rounded-r-full">Año</button>
                    </div>
                {/* Selector de fecha entre rango de fechas */}
                <div className="flex flex-row ">
                    <input type="date" className="bg-white dark:bg-gray-700 dark:outline-none    hover:bg-gray-200 px-4 py-2 rounded-l-full" />
                        <input type="date" className="bg-white dark:bg-gray-700 dark:outline-none    hover:bg-gray-200  px-4 py-2 rounded-r-full" />
                </div>
                </div>
